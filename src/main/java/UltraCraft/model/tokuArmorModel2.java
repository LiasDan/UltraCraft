...
public class tokuArmorModel2 extends ModelBiped
{
	...
	public Class<? extends item_ultra_riser> base;  
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		float height=1;
		float height2=0;
		item_ultra_riser belt = (item_ultra_riser)UltraItems.beta_capsule;
		...
		if (entity instanceof EntityLivingBase){
			...
			belt = (item_ultra_riser) player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem();
			}
		}	
